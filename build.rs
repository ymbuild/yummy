...
fn main() {
    ...
    // Tell Cargo to rerun if agent sources change
    println!("cargo:rerun-if-changed=ym-agent/src");
    println!("cargo:rerun-if-changed=ym-agent/src/main/resources/META-INF/MANIFEST.MF");
}
