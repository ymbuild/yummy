...
| 3 | [包管理命令](03-package-management.md) | `03-package-management.md` | ✅ 已实现 | `commands/{add,remove,install,...}.rs` |
...
| 11 | [诊断与工具](11-diagnostics.md) | `11-diagnostics.md` | ✅ 已实现 | `commands/{doctor,env,validate,...}.rs` |
...
| 16 | [安全](16-security.md) | `16-security.md` | ⚠️ 部分实现 | `commands/audit.rs`, `commands/verify.rs` |
...
关键任务：
- [ ] 建立基准测试项目（小/中/大）
- [ ] Version Range / SNAPSHOT / Classifier 支持
- [ ] ECJ 集成
- [ ] 测试报告（JUnit XML）
